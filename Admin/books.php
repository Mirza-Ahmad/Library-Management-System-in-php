...
<div class="srch">
<form class="navbar-form" method="post" name="form1" action="books_search.php">
...
<form class="navbar-form" method="post" action="deletebooks.php">
<input type="text" class="form-control" name="bid" required="" placeholder="Enter Book Id"  id="qw">
<button style="background-color: #6db6b9e6; " type="submit" name="submit1" required="" class="form-control">Delete
</button>
</form>
</div>
    <?php
